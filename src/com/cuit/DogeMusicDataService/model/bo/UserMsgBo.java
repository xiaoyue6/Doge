...
public class UserMsgBo {
	...
	public UserMsgBo(UserMsgVo vo)
	{
		this.account = vo.getAccount();
		this.age = vo.getAge();
		this.sex = vo.getSex();
		this.nation = vo.getNation();
		this.email = vo.getEmail();
		this.userLevel = vo.getUserLevel();
	}
	public UserMsgBo(String account, Integer age, String sex, String nation,
